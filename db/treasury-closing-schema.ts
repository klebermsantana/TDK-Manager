...
export const treasuryAlertSettings = sqliteTable(
  "treasury_alert_settings",
  {
    ...
    criticalAckSlaMinutes: integer("critical_ack_sla_minutes").notNull().default(30),
    highAckSlaMinutes: integer("high_ack_sla_minutes").notNull().default(120),
    resolutionSlaMinutes: integer("resolution_sla_minutes").notNull().default(240),
