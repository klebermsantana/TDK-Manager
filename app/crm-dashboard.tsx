      ...
      <main className="main">
        ...
        <div className="content">
          ...
          {loading ? (
            ...
            <ServiceCalls calls={serviceCalls} history={serviceCallHistory} changeStatus={changeServiceCallStatus} inspect={call=>setSelectedServiceCallId(call.id)} />
          ) : view === "sales" ? (
...
function ServiceCalls({calls,history,changeStatus,inspect}:{calls:ServiceCall[];history:ServiceCallHistory[];changeStatus:(call:ServiceCall,status:string)=>void;inspect:(call:ServiceCall)=>void}){
