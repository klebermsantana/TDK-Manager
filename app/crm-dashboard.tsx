...
type ServiceCall={id:number;number:string;companyId:number|null;companyName:string;serviceTaker:string|null;requestOrigin:string|null;department:string|null;customerTicket:string|null;saleId:number|null;location:string|null;contactName:string|null;technician:string|null;serviceType:string;priority:string;scheduledAt:string|null;status:string;subject:string;description:string;createdBy:string;createdAt:string;updatedAt:string};
...
export default function CrmDashboard({
  ...
  const [serviceCallForm,setServiceCallForm]=useState({companyId:"",serviceTaker:"",requestOrigin:"telefone",department:"",customerTicket:"",saleId:"",location:"",contactName:"",technician:"",serviceType:"visita",priority:"normal",scheduledAt:"",subject:"",description:""});
  ...
  function openNew(kind: "company" | "contact" | "opportunity" | "activity" | "goal" | "proposal" | "catalog" | "payable" | "member" | "service_call") {
    ...
    if (kind === "service_call") setServiceCallForm({companyId:"",serviceTaker:"",requestOrigin:"telefone",department:"",customerTicket:"",saleId:"",location:"",contactName:"",technician:"",serviceType:"visita",priority:"normal",scheduledAt:"",subject:"",description:""});
    setDialog(kind);
  }
